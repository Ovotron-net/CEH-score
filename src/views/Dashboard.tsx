            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                            ...
                            recentAssessments.map((assessment) => (
                                <div key={assessment.id}
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span
                                            className={`px-2 py-1 rounded text-xs font-medium ${assessment.percentage >= 70 ? 'bg-primary/10 text-primary' : 'bg-red-500/10 text-red-400'}`}>
                      {assessment.percentage}%
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span
                                            className="text-muted-foreground">{new Date(assessment.date).toLocaleDateString()}</span>
                                    </div>
                                </div>
                            ))
                        )}
                ...
                <div className="glass-card rounded-xl p-6 cyber-glow-blue card-enter">
                    ...
                    <div className="space-y-3">
                        ...
                        <Link href="/analytics"
                              className="w-full flex items-center justify-between p-4 bg-blue-500/10 hover:bg-blue-500/15 border border-blue-500/20 hover:border-blue-500/30 rounded-lg transition-all group">
                            <div>
                        ...
                        <Link href="/topics"
                              className="w-full flex items-center justify-between p-4 bg-purple-500/10 hover:bg-purple-500/15 border border-purple-500/20 hover:border-purple-500/30 rounded-lg transition-all group">
                            <div>
