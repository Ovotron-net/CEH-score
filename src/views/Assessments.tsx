    ...
    return (
        <div className="p-6 lg:p-8 page-enter">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
                ...
                <Link href="/add"
                      className="inline-flex items-center gap-2 px-4 py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-lg transition-all duration-200 cyber-glow">
            ...
            <div className="space-y-4">
                {filteredAssessments.length === 0 ? (
                    <div className="glass-card rounded-xl p-12 text-center">
                        ...
                        {assessments.length === 0 && (
                            <Link href="/add"
                                  className="inline-flex items-center gap-2 px-4 py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-lg transition-all duration-200">
                                <Plus className="w-4 h-4"/>
                    ...
                    filteredAssessments.map((assessment) => (
                        <div key={assessment.id}
                             className="glass-card rounded-xl p-6 hover:border-primary/30 transition-all duration-200 card-enter">
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                <div className="flex-1">
                                    <div className="flex flex-wrap items-center gap-3 mb-3">
                    <span
                        className="px-3 py-1 rounded-full text-xs font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 capitalize">
                      {assessment.type}
                    </span>
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs font-medium border ${assessment.percentage >= 70 ? 'bg-primary/10 text-primary border-primary/20' : 'bg-red-500/10 text-red-400 border-red-500/20'}`}>
                      {assessment.percentage >= 70 ? 'Passed' : 'Failed'}
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                                        <div>
                                            ...
                                            <div
                                                className="font-semibold text-white">{formatScore(assessment.score)} / {formatScore(assessment.maxScore)}</div>
                                        </div>
                                        <div>
                                            <div className="text-muted-foreground mb-1">Percentage</div>
                                            <div
                                                className={`font-semibold ${assessment.percentage >= 70 ? 'text-primary' : 'text-red-400'}`}>
