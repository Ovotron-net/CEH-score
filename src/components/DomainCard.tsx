...
const DomainCard = memo(function DomainCard({ domain, assessmentCount = 0, avgScore }: DomainCardProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl overflow-hidden hover:border-primary/20 transition-all duration-200 card-enter">
      <div
        ...
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mt-2 flex-wrap">
              ...
              {avgScore !== undefined && (
                <span className={`text-xs font-medium ${avgScore >= 70 ? 'text-primary' : 'text-red-400'}`}>
                  Avg: {avgScore}%
                </span>
              )}
            </div>
